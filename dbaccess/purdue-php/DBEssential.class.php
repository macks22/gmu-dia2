...
class DBEssential {
    ...
    function loadStateOrg() {
        ...
        $res = executeSQLSequence($this->dupDocIDs, array(
            "select personID as id from document_person where documentID in (#) and relationshipID in ($authorshipID)",
            "select affiliationID as id from person where id in (#)",
